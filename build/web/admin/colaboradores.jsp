<%-- 
    ...
    Created on : 2 de dez. de 2022, 19:45:55
    Author     : Alunos
--%>
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Cadastrar Colaboradores</li>
                        </ol>
                    </div>
                    <div class="container-fluid px-4">
                        <small>Formulário de cadastro de colaboradores</small>
                        <form action="config/cadastraColaboradores.jsp" method="POST" enctype="multipart/form-data">
                            <div class="mb-3">
                                <label class="form-label">Nome do colaborador</label>
                                <input type="text" class="form-control" name="nome" placeholder="Nome do colaborador"/> 
                            </div>
                            <div class="mb-3">
                            ...
                            <tbody>
                                <% 
                                    ...
                                    try{
                                         ...
                                         rs = st.executeQuery("SELECT *FROM colaborador ORDER BY id DESC");
                                         while(rs.next()){ 
                                    ...
                                    %>
                                          <tr>
                                              ...
                                              <td>
                                                  <a href="editarColaborador.jsp?id=<%=rs.getString("id")%>" class="text-info" ><i class="fa fa-pencil-square"></i></a>
                                              ...
                                              <div class="modal-dialog">
                                                <div class="modal-content">
                                                  ...
                                                  <div class="modal-footer">
                                                    ...
                                                    <a href="colaboradores.jsp?funcao=excluir&id=<%=rs.getString(1)%>&imagem=<%=rs.getString("imagem")%>" class="btn btn-danger">Excluir</a>
                                                  </div>
                                                </div>
                                              </div>
                                            </div>
