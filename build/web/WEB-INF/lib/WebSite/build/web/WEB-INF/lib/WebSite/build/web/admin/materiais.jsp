                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Cadastrar Materiais</li>
                        </ol>
                    </div>
                    <div class="container-fluid px-4">
                        <small>Formulário de cadastro de materiais</small>
                        <form action="config/cadastraMateriais.jsp" method="POST" enctype="multipart/form-data">
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="desc" placeholder="Descrição do material"/> 
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Valor do material</label>
                                <input type="text" class="form-control" name="valor" placeholder="Valor do material"/> 
                            </div>
                            <div class="mb-3">
                                ...
                                <% 
                                    ...
                                    %>
                                          <tr>
                                              ...
                                              <td>
                                                  <a href="editarMaterial.jsp?id=<%=rs.getString("id")%>" class="text-info" ><i class="fa fa-pencil-square"></i></a>
                                              ...
                                              <div class="modal-dialog">
                                                <div class="modal-content">
                                                  <div class="modal-header">
                                                    <h1 class="modal-title fs-5" id="exampleModalLabel">Excluir Material</h1>
                                                  ...
                                                  <div class="modal-footer">
                                                    ...
                                                    <a href="materiais.jsp?funcao=excluir&id=<%=rs.getString(1)%>&imagem=<%=rs.getString("imagem")%>" class="btn btn-danger">Excluir</a>
                                                  </div>
                                                </div>
                                              </div>
                                            </div>
                    ...
                    <%
                        if(request.getParameter("funcao")!= null && request.getParameter("funcao").equals("excluir")){
                            ...
                            try{
                                ...
                                con = DriverManager.getConnection(url,usuario,senhaBD);
                                st = con.createStatement();
                                st.executeUpdate("DELETE from material WHERE id = '"+id+"' ");
                                response.sendRedirect("materiais.jsp?status=3");//Registro deletado com sucesso
                            }catch(Exception e){
                                out.println(e);
                            }
                        }
