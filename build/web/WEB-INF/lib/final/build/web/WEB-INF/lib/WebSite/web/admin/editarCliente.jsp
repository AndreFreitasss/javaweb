            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    <div class="container-fluid px-4">
                        ...
                        <form action="config/editarCliente.jsp?id=<%=rs.getString("id")%>" method="POST">
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="senha" class="form-control" value="<%=rs.getString("senha")%>" name="senha" placeholder="Informe uma senha" />
                            </div>
