                    ...
                    <div class="container-fluid px-4">
                        ...
                        <form action="config/editarColaborador.jsp?id=<%=rs.getString("id")%>&imagem=<%=rs.getString("imagem")%>" method="POST" enctype="multipart/form-data">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="nome" placeholder="Nome do colaborador" value="<%=rs.getString("nome")%>"/> 
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Área que trabalha</label>
                                <input type="text" class="form-control" name="area" placeholder="Área em que trabalha" value="<%=rs.getString("area")%>"/> 
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Telefone</label>
                                <input type="text" class="form-control" name="telefone" placeholder="Telefone" value="<%=rs.getString("telefone")%>"/> 
                            </div>
                            <div class="mb-3">
                                <label class="form-label">E-mail</label>
                                <input type="text" class="form-control" name="email" placeholder="E-mail" value="<%=rs.getString("email")%>"/> 
                            </div>
                            <div class="mb-3">
